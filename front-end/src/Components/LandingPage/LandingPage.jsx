              ...
              <div ><br />
                ...
                <div  >
                  <div className={styles.btns}>
                    ...
                    <input className={styles.inp} type="text" placeholder="Enter your mobile number" />
                    <br /><br />
        ...
        <div>
          <div className={styles.prms3}>
            ...
            <div className={styles.prms2}>
              ...
              <div className={styles.text2}>We take care of your travel beyond ticketing by providing you with innovative and unique benefits.</div>
            </div>
          </div>
        </div>
      </div>
