      ...
      <div className={Styles.faqDivContainer}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>What is redBus Hire?</div>
            {arrow1 === "downArrow" && (
              <img
          ...
          {arrow1 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              redBus Hire helps you rent a vehicle from the best operators in
              your city.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>How does it work?</div>
            {arrow2 === "downArrow" && (
              <img
                src="https://www.redbus.in/bushire/static/mwebv2/home/ic-arrow-down-color.svg"
                alt=""
          ...
          {arrow3 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              ...
              Hyderabad, Delhi, Ahmedabad, Madurai, Mysore, Visakhapatnam,
              Surat, Vadodara, Vijayawada, Coimbatore, Goa, Pondicherry, Erode,
              Ooty, Udaipur, Jaipur, Guwahati, Trichy and Kolkata.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>
          ...
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>What are the payment terms?</div>
            {arrow6 === "downArrow" && (
              <img
                src="https://www.redbus.in/bushire/static/mwebv2/home/ic-arrow-down-color.svg"
                alt=""
          ...
          {arrow7 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              What if I need to cancel my trip? Cancellation policy is specific
              to each operator and is listed against the quotes on the
              quotations page.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
          ...
          {arrow8 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              Tolls and Interstate taxes are best estimates only. If these
              amounts are included in the fare, you'll be charged/reimbursed for
              any difference between the actuals and estimations, as applicable.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>
          ...
          {arrow9 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              redBus is among the leading online booking services and for a good
              ...
              boosts passenger age inclusivity and may also contain amenities
              like a mini-refrigerator or icebox.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>
          ...
          {arrow10 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              redBus, in light of the recent rapid spread of COVID-19, has
              introduced a new move which they call Safety+. Under Safety+, all
              buses are required to adhere to certain strict rules and
              guidelines. Some of these include regular and strict temperature
              checks along with advisories, making the use of masks mandatory
              for all employees as well as passengers, and sanitisers must be
              provided before boarding and present on all buses at all times.
            </div>
          )}
          <div className={Styles.faqsEachDiv}>
            <div className={Styles.faqDivText}>
          ...
          {arrow11 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              redBus customer care is available at all hours, that is, 24/7. The
              customer care staff are friendly and can be asked about any redBus
          ...
          {arrow12 === "upArrow" && (
            <div className={Styles.faqsEachAnswerDiv}>
              ...
              pandemic, redBus will not be allowing the provision of blankets
              and various other cover-ups. This measure falls under the Safety+
              guidelines.
            </div>
          )}
          <div style={{marginTop:"20px"}}>
             <div> <h2>Join Bus Hire as an operator</h2></div>
             <div style={{fontSize:"16px",width:"458px"}}><p> If you are an operator who is in the hire/rental business and would like to be on boarded on redBus.</p></div>
             <div ><button style={{
                 padding: "13px 30px",
                 fontSize: "16px",
